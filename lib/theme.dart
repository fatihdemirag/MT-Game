...
Color unsuccess = Colors.red;


TextStyle headlines = TextStyle(letterSpacing: 2.0,fontSize: 26, color: HexColor("d3d3d3"));
TextStyle boldNumber = TextStyle(color: HexColor("fbfbfb"), fontWeight: FontWeight.bold,fontSize: 32.0);
TextStyle boldNumberTransaction = TextStyle(color: HexColor("fbfbfb"), fontWeight: FontWeight.bold,fontSize: 48.0);
